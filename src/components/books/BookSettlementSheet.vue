<template>
  <Teleport to="body">
    ...
    >
      ...
      ></div>
      <div
        class="animate-slide-up relative flex max-h-[85vh] w-full max-w-md flex-col rounded-t-[2rem] bg-gray-50 shadow-2xl transition-colors dark:bg-gray-900"
      >
        <!-- Header -->
        <div
          class="z-10 flex shrink-0 items-center justify-between rounded-t-[2rem] border-b border-transparent bg-white px-6 py-4 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)] transition-colors dark:border-gray-800 dark:bg-gray-800 dark:shadow-none"
        >
          <div>
            <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">
              {{ $t("settlementSheet.title") }}
            </h2>
            <p
        ...
        <!-- Body -->
        <div class="custom-scrollbar space-y-6 overflow-y-auto px-4 py-6">
          <!-- Member Stats -->
          <div>
            <h3
