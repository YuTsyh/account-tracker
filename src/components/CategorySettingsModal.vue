<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          class="z-10 flex items-center justify-between bg-white px-6 py-4 shadow-sm dark:bg-gray-800"
        >
        ...
        <div class="custom-scrollbar flex-1 overflow-y-auto px-4 py-6">
          <!-- Expense -->
          <div class="mb-6">
        ...
        <div
          class="z-10 border-t border-gray-100 bg-white p-4 shadow-[0_-10px_30px_rgba(0,0,0,0.05)] transition-colors dark:border-gray-700 dark:bg-gray-800"
        >
      ...
      >
        <div
          class="z-10 flex items-center justify-between bg-white px-6 py-4 shadow-sm transition-colors dark:bg-gray-800"
        >
        ...
        <div
          class="custom-scrollbar flex-1 space-y-6 overflow-y-auto px-5 py-6"
        >
          <!-- Type -->
          <div
            class="flex rounded-xl bg-gray-200/60 p-1 transition-colors dark:bg-gray-800"
          >
            <button
              type="button"
          ...
          <!-- Name & Preview -->
          <div
            class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800"
          >
          ...
          <div>
            <label
              class="mb-3 block text-sm font-bold text-gray-700 dark:text-gray-300"
              >主題色</label
            >
        ...
        <div
          class="z-10 border-t border-gray-100 bg-white p-4 shadow-[0_-10px_30px_rgba(0,0,0,0.05)] transition-colors dark:border-gray-700 dark:bg-gray-800"
        >
          <BaseButton class="w-full" :disabled="!newForm.name.trim()" @click="saveCustomCategory">
            {{ $t("categories.addConfirm") }}
          </BaseButton>
        </div>
      </div>
